  Web Services \[Deprecated\] — Qflow Cloud        
...
# Web Services \[Deprecated\][](#web-services-deprecado "Link to this heading")
...
The WebKpi web service allows you to retrieve information about the web site’s indicators

#### WebChart methods[](#metodos-de-webkpi "Link to this heading")

*   **GetPackageKpis(Guid packageId):KpiMessage\[\]** - it returns an array of objects of KpiMessage class, which contains information about a indicator such as its name, description and formula. These objects correspond to indicators located in the package identified by “packageId”.
    
*   **GetMyPackageKpis(Guid packageId):KpiMessage\[\]** - it returns an array of objects of KpiMessage class, corresponding to indicators located in the package identified by “packageId” and belonging to the current user.
    
*   **GetKpi(Guid kpiId):KpiMessage** - it returns a KpiMessage object corresponding to the indicator identified by parameter “kpiId”.
    
*   **GetMyKpi(Guid kpiId):KpiMessage** - it returns a KpiMessage object corresponding to the indicator identified by parameter “kpiId”, as long as the indicator belongs to the current user.
    
*   **GetKpiValue(KpiDataRequest request):decimal** - it returns the value of the indicator with the parameters indicated in the request object.
    
*   **GetMyKpiValue(KpiDataRequest request):decimal** - it returns the value of the indicator with the parameters indicated in the “request” object, as long as the chart belongs to the current user.
