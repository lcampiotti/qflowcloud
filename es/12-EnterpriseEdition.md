...
Por información relativa a los procedimientos de instalación y administración de la versión **Enterprise**, consulte el manual [Instalación y Configuración de Qflow](02-InstallationAndConfiguration.md).
