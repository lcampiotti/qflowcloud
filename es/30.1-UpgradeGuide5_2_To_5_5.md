...
La migración de la versión 5.2 a la [versión 5.5](29.6-ReleaseNote5_5.md) del producto incluye los cambios de las versiones [5.3](29.4-ReleaseNote5_3.md) y [5.4](29.5-ReleaseNote5_4.md). Estas versiones fueron liberadas para la versión _Cloud_ del producto, y con la liberación de la versión 5.5, se incluyen sus cambios a la versión _OnPremise_ del producto.
...
*   **Configuración de reCaptcha para inicio de procesos externos/anónimos:** se debe incluir la siguiente configuración para habilitar un desafío reCaptcha para el inicio de procesos externos/anónimos:
    ...
    Para habilitar el desafío reCaptcha, debemos completar los valores para las propiedades _ReCAPTCHASiteKey_ y _ReCAPTCHASecretKey_. Puede leer sobre cómo obtener estos valores [aquí](02-InstallationAndConfiguration.md#recaptchaconfiguration).
