...
*   [Qflow Task](#)
    ...
    *   [Descripción de Qflow Task](#descripcion-de-qflow-task)
        *   [Funcionamiento general de la interfaz de usuario](#funcionamiento-general-de-la-interfaz-de-usuario)
    *   [Trabajo con procesos y tareas](#trabajo-con-procesos-y-tareas)
        *   [Procesos, plantillas y tareas](#procesos-plantillas-y-tareas)
        ...
        *   [Trabajar con procesos](#trabajar-con-procesos)
    ...
    *   [Administración y configuración](#administracion-y-configuracion)
        ...
        *   [Personalización del menú lateral](#personalizacion-del-menu-lateral)
        *   [Mis vínculos](#mis-vinculos)
        *   [Vistas del sistema](#vistas-del-sistema)
        *   [Bandejas de colas de trabajo](#bandejas-de-colas-de-trabajo)
        *   [Permisos de paquete](#permisos-de-paquete)
...
*   [Descripción de Qflow Task](#descripcion-de-qflow-task): describe brevemente el sitio, su estructura y la relación de cada una de sus partes con las funcionalidades de Qflow.
...
## Descripción de Qflow Task[](#descripcion-de-qflow-task "Link to this heading")

La [Figura 294](#website) muestra Qflow Task tal cual lo ve un usuario con todos los permisos cuando Qflow está recién instalado.
...
*   **Mis favoritos:** muestra una vista de vínculos favoritos y permite modificar esa lista. También permite elegir la página de inicio. Tiene un submenú con las siguientes opciones:
    ...
    *   **Definir como página de inicio:** hace que la página actual sea la página de inicio. Si el cursor está sobre esta opción, aparece un ícono adicional ([![image1](_images/image279.png)](_images/image279.png)) que permite reestablecer la página de inicio por defecto.
        
    *   **Vínculos**: a la opción de definir la página actual como página de inicio siguen los vínculos que se hayan agregado como favoritos. Si el cursor se encuentra sobre alguno de los vínculos existentes, aparece un ícono adicional (“[![image2](_images/image312.png)](_images/image312.png)”) que permite eliminar el vínculo de favoritos.
        
    *   **Agregar a mis vínculos favoritos:** agrega a la lista de vínculos favoritos un vínculo a la página actual.
        
*   **Configurar:** permite acceder a las opciones de configuración. Las opciones de configuración se describen en la sección [Administración y configuración](#administracion-y-configuracion).
...
*   **Menú de usuario:** permite habilitar o deshabilitar las notificaciones, cerrar sesión (sign out) y acceder a la configuración de tu zona horaria. Para obtener más detalles, consulta la sección de manejo de zonas horarias. Para más información revisar la sección [Manejo de zonas horarias](#manejo-de-zonas-horarias).
    

[![Menú superior](_images/image410.png)](_images/image410.png)

Figura 295 Menú superior[](#id12 "Link to this image")

[![Edición de favoritos](_images/image512.png)](_images/image512.png)

Figura 296 Edición de favoritos[](#id13 "Link to this image")

El menú lateral muestra varias opciones con sus nombres e íconos que los representan. Los nombres se pueden ocultar, haciendo que el menú se reduzca, ocupe menos espacio y solo se vean los íconos. Para esto se debe hacer clic en el ícono que aparece en el rincón superior izquierdo, al lado del logo de Qflow Task ([Figura 297](#reducedmenu)).

[![Qflow Task con el menú reducido](_images/image613.png)](_images/image613.png)

Figura 297 Qflow Task con el menú reducido[](#id14 "Link to this image")

Las opciones por defecto del menú lateral son las que aparecen en la siguiente lista, sin embargo, los elementos del menú lateral pueden ser [modificados](#sidebarconfiguration). Tenga en cuenta que estos elementos pueden mostrarse o no, dependiendo de los permisos del usuario.
...
*   **Iniciar proceso:** permite a los usuarios iniciar los procesos creados en Qflow Design.
...
*   **General:** esta opción tiene las siguientes subopciones:
    ...
    *   **Tareas:** permite acceder a la lista de tareas que el usuario tiene permiso de ver. Puede incluir tareas que no están esperando acciones suyas, a diferencia de la vista Mis tareas, que está disponible a través del menú superior. Las vistas de tareas se describen en la sección [Trabajar con tareas](#trabajar-con-tareas).
...
#### Ejecución de operaciones[](#ejecucion-de-operaciones "Link to this heading")

Para ejecutar una operación sobre un elemento, hay dos opciones:

1.  Seleccionarlo y hacer clic en el botón que corresponde a la operación ([Figura 299](#operationexecution)). Para seleccionar un elemento:
...
[![La vista “Procesos”, como todas las vistas de procesos, se muestra como una tabla](_images/image710.png)](_images/image710.png)

Figura 298 La vista “Procesos”, como todas las vistas de procesos, se muestra como una tabla[](#id15 "Link to this image")

[![Ejecución de una operación](_images/image810.png)](_images/image810.png)

Figura 299 Ejecución de una operación[](#id16 "Link to this image")

[![Las vistas de plantillas muestran íconos en lugar de filas de una tabla](_images/image910.png)](_images/image910.png)

Figura 300 Las vistas de plantillas muestran íconos en lugar de filas de una tabla[](#id17 "Link to this image")

#### Opciones de búsqueda, visualización y filtros[](#opciones-de-busqueda-visualizacion-y-filtros "Link to this heading")

Los botones que se muestran agrupados sobre el recuadro que muestra la lista de elementos, a la derecha, permiten modificar qué se muestra en la lista y, en algunos casos, cómo se muestra. La [Figura 301](#filteroptions) tiene un detalle de esa parte de la pantalla, con una pequeña descripción de cada botón. Las opciones que permiten buscar y actualizar la lista están disponibles para todas las listas. Las otras, solamente cuando las listas se muestran como tablas. A continuación, se describe cada una en mayor detalle:
...
*   **Filas/columnas:** cambia la forma de mostrar la vista: cada elemento de la vista se muestra en una fila que, a su vez, tiene varias subfilas, una por cada columna de la vista. La [Figura 302](#linecolumnview) muestra la misma vista y con los mismos elementos, que la [Figura 298](#processview), pero después de hacer clic en ese botón. Si se vuelve a hacer clic en el botón, se vuelve al formato original. Es especialmente útil en el caso de pantallas pequeñas o con tantas columnas que no todas caben en la pantalla.
    
*   **Seleccionar columnas a mostrar:** muestra la lista de columnas de la vista, con casilleros que se pueden desmarcar para ocultar o volver a mostrar las columnas que se deseen ([Figura 303](#processviewwithoutdescription)).
    
*   **Exportar:** Exporta el contenido del listado a un archivo (formato CSV, HTML y Excel) en el equipo del usuario.
    

[![Opciones de visualización y filtros](_images/image1010.png)](_images/image1010.png)

Figura 301 Opciones de visualización y filtros[](#id18 "Link to this image")

[![Vista mostrada con la opción Filas/Columnas](_images/image1110.png)](_images/image1110.png)

Figura 302 Vista mostrada con la opción Filas/Columnas[](#id19 "Link to this image")

[![Vista "Procesos" sin la columna "Descripción", que se desmarcó](_images/image1210.png)](_images/image1210.png)

Figura 303 Vista «Procesos» sin la columna «Descripción», que se desmarcó[](#id20 "Link to this image")

#### Orden de los elementos en las tablas[](#orden-de-los-elementos-en-las-tablas "Link to this heading")
...
## Trabajo con procesos y tareas[](#trabajo-con-procesos-y-tareas "Link to this heading")

Esta sección describe cómo iniciar procesos, ver sus datos y responder a sus tareas.

### Procesos, plantillas y tareas[](#procesos-plantillas-y-tareas "Link to this heading")
...
### Iniciar proceso[](#iniciar-proceso "Link to this heading")
...
2.  Busque la plantilla que desea usar para iniciar el proceso. Si hay muchas plantillas, puede escribir en el campo “Buscar” un texto con parte del texto descriptivo que se muestra en pantalla para la plantilla (el texto descriptivo está formado por el nombre de la plantilla, el nombre de la versión entre paréntesis y la descripción de la plantilla; ver [Figura 304](#flowtemplate). Las plantillas que se muestran no tienen descripción). Esto hace que Qflow filtre la lista y muestre solamente las plantillas que tengan ese texto.
    
3.  Haga clic en el ícono que representa la plantilla que desee utilizar (por ejemplo, en el círculo con una letra A en el caso de la primera plantilla de la [Figura 304](#flowtemplate)). Esto lo lleva al formulario de inicio del proceso. Alternativamente, puede seleccionar la plantilla haciendo clic en su nombre y después hacer clic en el botón de “Iniciar proceso” ([![image3](_images/image1310.png)](_images/image1310.png)). La [Figura 305](#startflowexample) muestra un formulario estándar de Qflow.
...
[![Plantillas de procesos](_images/image1410.png)](_images/image1410.png)

Figura 304 Plantillas de procesos[](#id21 "Link to this image")

[![Ejemplo de un formulario estándar de inicio de un proceso](_images/image1510.png)](_images/image1510.png)

Figura 305 Ejemplo de un formulario estándar de inicio de un proceso[](#id22 "Link to this image")
...
Dado que las zonas horarias en las que Qflow muestra las fechas dependen de la preferencia del usuario, y que en el caso de un inicio externo/anónimo no se tiene esa preferencia, se explicita la zona horaria en la que se consideran las fechas en la parte superior izquierda del formulario ([Figura 306](#externalflowstartform)).

[![Inicio de proceso externo/anónimo](_images/external-flow-start.png)](_images/external-flow-start.png)

Figura 306 Inicio de proceso externo/anónimo[](#id23 "Link to this image")

### Trabajar con tareas[](#trabajar-con-tareas "Link to this heading")
...
#### Tareas pendientes de un usuario[](#tareas-pendientes-de-un-usuario "Link to this heading")

Un usuario puede tener varias tareas que esperan una respuesta suya. Para consultar las tareas que tiene pendientes, por lo general lo más práctico es usar el vínculo “Mis tareas” del menú superior (ver [Descripción de Qflow Task](#descripcion-de-qflow-task)). El ícono de ese vínculo muestra la cantidad de tareas que el usuario tiene pendientes. Al hacer clic en ese ícono, aparece un menú con el asunto de algunas de las tareas pendientes ([Figura 307](#pendingtaskmenu)). Al lado de cada asunto figura el estado (“Normal”, en el ejemplo). En la parte inferior del menú hay un vínculo que permite acceder a una vista que contiene todas las tareas pendientes del usuario. Esta vista muestra más datos.

[![Menú con tareas pendientes](_images/image1610.png)](_images/image1610.png)

Figura 307 Menú con tareas pendientes[](#id24 "Link to this image")

#### Responder una tarea[](#responder-una-tarea "Link to this heading")
...
[![Tabla de mis tareas](_images/image1252.png)](_images/image1252.png)

Figura 308 Tabla de mis tareas[](#id25 "Link to this image")
...
[![Tabla de mis tareas](_images/image1262.png)](_images/image1262.png)

Figura 309 Tabla de mis tareas[](#id26 "Link to this image")
...
[![Tareas en segundo plano](_images/image1272.png)](_images/image1272.png)

Figura 310 Tareas en segundo plano[](#id27 "Link to this image")

Adicionalmente, puede navegar a otras secciones del sitio mientras sus respuestas se completan en segundo plano.

[![Tabla de tareas en segundo plano](_images/image1282.png)](_images/image1282.png)

Figura 311 Tabla de tareas en segundo plano[](#id28 "Link to this image")
...
[![Email con opciones de respuesta rápida](_images/image1292.png)](_images/image1292.png)

Figura 312 Email con opciones de respuesta rápida[](#id29 "Link to this image")

[![Mensaje de confirmación de respuesta](_images/image1301.png)](_images/image1301.png)

Figura 313 Mensaje de confirmación de respuesta[](#id30 "Link to this image")

[![Pantalla para adición de comentario](_images/image1312.png)](_images/image1312.png)

Figura 314 Pantalla para adición de comentario[](#id31 "Link to this image")
...
Podemos asignar tareas a usuarios externos mediante el uso de su _correo electrónico_ como destinatario de las mismas, de modo que al despacharse una tarea, recibirán un correo con un enlace de acceso al formulario de la tarea para poder dar respuesta a la misma, sin necesitar de un usuario de Qflow. Podemos configurar datos, parámetros o especificar directamente las direcciones de correo a las cuales despachar la tarea. Al igual que en el inicio de tarea externo/anónimo, el formulario de respuesta de tareas externas muestra la zona horaria que Qflow considera para todas las fechas y horas del formulario ([Figura 316](#externaltaskform)).

[![Tarea con destinatarios externos usando datos, parámetros y correos electrónicos](_images/QflowTask_ExternalTaskAddressees.png)](_images/QflowTask_ExternalTaskAddressees.png)

Figura 315 Tarea con destinatarios externos usando datos, parámetros y correos electrónicos[](#id32 "Link to this image")

[![Formulario de respuesta de tarea externa](_images/QflowTask_ExternalTaskForm.png)](_images/QflowTask_ExternalTaskForm.png)

Figura 316 Formulario de respuesta de tarea externa[](#id33 "Link to this image")

Las acciones de los usuarios externos en sus tareas también se ven reflejadas en las auditorías e historiales del sistema, identificados por el correo electrónico al cual fue despachada la tarea, indicando que es un usuario _Invitado_.

[![Historial de respuesta de tarea con usuario externo](_images/QflowTask_ExternalTaskAudit.png)](_images/QflowTask_ExternalTaskAudit.png)

Figura 317 Historial de respuesta de tarea con usuario externo[](#id34 "Link to this image")
...
[![Mensaje de confirmación](_images/QflowTask_ConfirmationMessage.png)](_images/QflowTask_ConfirmationMessage.png)
...
Para revisar las tareas de una cola de trabajo a la que pertenece, utilice la sección “Colas de trabajo” del menú lateral. Para acceder a una pantalla que muestra todas las colas que usted está autorizado a ver, haga clic en el propio vínculo “Colas de trabajo”. Una vez en esa pantalla, puede acceder a una cola de trabajo haciendo clic en su ícono o seleccionándola y después haciendo clic en la flecha ([![image4](_images/image1710.png)](_images/image1710.png)). Alternativamente, puede acceder a una cola de trabajo directamente desde el menú lateral: si hace clic en la flechita que aparece al lado de la opción “Colas de trabajo”, las colas de trabajo en las que tiene permiso de actuar se muestran en el propio menú lateral ([Figura 320](#workqueuelist)). Para acceder a una de ellas, hágale clic.

[![Pantalla de colas de trabajo con tres colas de trabajo](_images/image1810.png)](_images/image1810.png)

Figura 319 Pantalla de colas de trabajo con tres colas de trabajo[](#id36 "Link to this image")

[![Opción "Colas del trabajo" del menú lateral, desplegada para mostrar tres colas de trabajo como subopciones](_images/image1910.png)](_images/image1910.png)

Figura 320 Opción «Colas del trabajo» del menú lateral, desplegada para mostrar tres colas de trabajo como subopciones[](#id37 "Link to this image")

#### Tareas de una cola de trabajo[](#tareas-de-una-cola-de-trabajo "Link to this heading")

La pantalla de una cola de trabajo ([Figura 321](#workqueuepanel)) muestra la bandeja de entrada de esa cola.
...
[![Delegar tarea](_images/image2110.png)](_images/image2110.png)

Figura 322 Delegar tarea[](#id39 "Link to this image")

#### Reenvío de mensajes, envío de alertas y de recordatorios[](#reenvio-de-mensajes-envio-de-alertas-y-de-recordatorios "Link to this heading")
...
### Trabajar con procesos[](#trabajar-con-procesos "Link to this heading")
...
#### Datos y operaciones sobre procesos[](#datos-y-operaciones-sobre-procesos "Link to this heading")

A través de las vistas de procesos se puede acceder a información de los procesos y ejecutar operaciones sobre ellos, como por ejemplo, hacer seguir la ejecución de un proceso que estaba detenido en un error o finalizar un proceso a la fuerza. Las vistas de procesos se muestran como tablas y funcionan como se describe en [Funcionamiento general de la interfaz de usuario](#funcionamiento-general-de-la-interfaz-de-usuario), donde también se explica cómo acceder a las operaciones que están disponibles. En esta sección se explica cuáles son esas operaciones y cómo funcionan. Las operaciones disponibles son las siguientes:

*   **Ver detalles:** permite ver datos detallados del proceso, como sus datos de aplicación (datos que el proceso utiliza y puede modificar), usuarios que participan, el diseño y en qué punto está, etc. Desde esta pantalla se pueden ejecutar acciones administrativas. Esa pantalla se describe en detalle más abajo (ver [Detalles del proceso](#detalles-del-proceso)).
...
*   **Ver tareas activas:** permite ver la lista de tareas que están pendientes de respuesta, con información de quiénes son los destinatarios. Puede haber más de una, porque un proceso puede tener ramas que se ejecutan en paralelo. Esta pantalla se describe más abajo (ver [Ver tareas activas](#ver-tareas-activas)).
...
##### Detalles del proceso[](#detalles-del-proceso "Link to this heading")
...
La solapa “General” ([Figura 323](#flowdetailsgeneral)) muestra datos básicos del proceso. Lo que se muestra en esta solapa es muy parecido a lo que se muestra en el formulario del proceso, cuando este es un formulario estándar (no personalizado). Se muestran dos grupos de datos: la información del proceso y la información de la plantilla del proceso.

[![Detalles del proceso/General](_images/image2210.png)](_images/image2210.png)

Figura 323 Detalles del proceso/General[](#id40 "Link to this image")
...
###### Diseño[](#diseno "Link to this heading")
...
[![Diseño del proceso: el proceso pasó dos veces por el paso Revisar documento.](_images/image2310.png)](_images/image2310.png)

Figura 324 Diseño del proceso: el proceso pasó dos veces por el paso Revisar documento.[](#id41 "Link to this image")

Un paso de una plantilla puede ser ejecutado más de una vez en un proceso si el proceso tiene un bucle (el paso siguiente a un paso es un paso que ya había sido ejecutado antes). Cuando esto sucede, Qflow lo indica en el diagrama con un número que aparece sobre el paso (ver [Figura 324](#niconiconi)). Este número solo aparece si el mismo paso del proceso fue ejecutado más de una vez, e indica cuántas veces ese paso fue ejecutado. Al posicionar el cursor sobre el número de ejecuciones del paso, se desplegarán burbujas con los números de ejecución. Al hacer clic en cualquiera de las ejecuciones se abrirán los detalles de esta.

###### Seguimiento[](#seguimiento "Link to this heading")

La solapa “Seguimiento” muestra información de los pasos ejecutados hasta ahora o que están siendo ejecutados ([Figura 325](#log)). Para todos los pasos se muestra la fecha en que comenzó su ejecución y para aquellos ya finalizados, se muestra también la fecha en la que finalizó su ejecución. Por defecto, se muestran solamente pasos interactivos (preguntas, tareas, notificaciones), hitos y, si el proceso finalizó naturalmente su ejecución, el paso de fin. Para que Qflow muestre otros pasos, marque la opción “Vista completa”.
...
Si el usuario tiene permisos en el paquete de “Administrar procesos”, tendrá la opción de Retroceder hasta el paso” (“[![image6](_images/image2410.png)](_images/image2410.png)”), donde Qflow calculará y ejecutará el retroceso de la mínima cantidad necesaria de pasos a retroceder hasta el paso seleccionado. Esta acción altera el flujo del proceso y podría restablecer sus datos, por lo que se recomienda utilizar con cautela.

Si hay etapas definidas para el proceso, la solapa incluye además dos gráficas: “Seguimiento del proceso” ([Figura 326](#flowlog)) y “Seguimiento del proceso por etapa” ([Figura 327](#stagelog)). La primera muestra el desempeño del proceso respecto de la suma de los tiempos definidos para la etapa actual y las ya transcurridas. La segunda detalla el desempeño obtenido etapa por etapa. Cuando se hace clic en alguna de las etapas, la lista de pasos ejecutados muestra solamente los pasos pertenecientes a esa etapa.

[![Seguimiento](_images/image2510.png)](_images/image2510.png)

Figura 325 Seguimiento[](#id42 "Link to this image")

[![Seguimiento del proceso](_images/image2610.png)](_images/image2610.png)

Figura 326 Seguimiento del proceso[](#id43 "Link to this image")

[![Seguimiento del proceso por etapa](_images/image2710.png)](_images/image2710.png)

Figura 327 Seguimiento del proceso por etapa[](#id44 "Link to this image")

###### Hilos[](#hilos "Link to this heading")

La solapa “Hilos” ([Figura 328](#processthread)) muestra los hilos, es decir, ramas del proceso (secuencias de pasos) que se ejecutan simultáneamente. Un proceso tiene por lo menos un hilo, pero puede tener más si hay un paso de separación, pues este puede hacer que varios pasos sean ejecutados en paralelo. En ese caso, el proceso se divide en varios hilos ([Figura 329](#processwithtwothreads)). Cuando un hilo se divide en varios hilos, se dice que éstos son hijos de aquel.

[![Hilos de un proceso](_images/image282.png)](_images/image282.png)

Figura 328 Hilos de un proceso[](#id45 "Link to this image")
...
[![El diseño de un proceso con dos hilos en ejecución](_images/image292.png)](_images/image292.png)

Figura 329 El diseño de un proceso con dos hilos en ejecución[](#id46 "Link to this image")

###### Detalle[](#detalle "Link to this heading")
...
De los datos de aplicación se muestran varias propiedades (nombre, descripción, valor, etc). Al igual que en una vista, se puede decidir ocultar algunas de las columnas que representan estas propiedades. Si un dato es multivaluado, sus valores se muestran uno a continuación del otro, separados por puntos y comas (“;”). Los datos se pueden mostrar agrupados. Esto sirve para datos que pertenecen al mismo grupo o bloque de línea ([Figura 331](#datablocks)).

[![Detalle](_images/image302.png)](_images/image302.png)

Figura 330 Detalle[](#id47 "Link to this image")
...
[![Tres datos del bloque “Contactos” se muestran agrupados. “Solicitud” no pertenece al bloque.](_images/image313.png)](_images/image313.png)

Figura 331 Tres datos del bloque “Contactos” se muestran agrupados. “Solicitud” no pertenece al bloque.[](#id48 "Link to this image")

[![El dato "Dato Historial" fue modificado dos veces](_images/image322.png)](_images/image322.png)

Figura 332 El dato «Dato Historial» fue modificado dos veces[](#id49 "Link to this image")

###### Historial[](#historial "Link to this heading")
...
[![Historial](_images/image332.png)](_images/image332.png)

Figura 333 Historial[](#id50 "Link to this image")

##### Ver tareas activas[](#ver-tareas-activas "Link to this heading")

La página de tareas activas muestra información de las tareas pendientes del proceso.

[![Tareas activas](_images/image342.png)](_images/image342.png)

Figura 334 Tareas activas[](#id51 "Link to this image")

Consulte la sección [Trabajar con tareas](#trabajar-con-tareas) por información sobre cómo trabajar con tareas.
...
[![Pantalla de vistas](_images/image352.png)](_images/image352.png)

Figura 335 Pantalla de vistas[](#id52 "Link to this image")

#### Creación de una vista[](#creacion-de-una-vista "Link to this heading")

Una vista se puede crear desde cero, o también se puede copiar una vista ya existente.

Para crear una vista, haga clic en la opción “Vistas” del menú lateral para acceder a la pantalla de vistas ([Figura 335](#viewspanel)). Una vez allí, haga clic en el ícono de copiar vista ([![image7](_images/image362.png)](_images/image362.png)) o en el de agregar vista (+). Si hace clic en el de copiar vista, Qflow muestra directamente la pantalla de definición de la vista (ver [Definición de una vista](#definicion-de-una-vista)).

Si hace clic en el ícono de agregar vista, Qflow lo lleva a una pantalla como la de la [Figura 336](#viewcreation).
...
[![Primer paso de la creación de una vista](_images/image382.png)](_images/image382.png)

Figura 336 Primer paso de la creación de una vista[](#id53 "Link to this image")

Para seleccionar el paquete:

1.  Haga clic en el ícono que aparece al lado del nombre del paquete raíz, como se muestra en la [Figura 337](#packageselection). Esto hace que aparezca el árbol de paquetes y que el ícono en el que hizo clic cambie para transformarse en un botón de confirmación ([Figura 338](#opentree)).
    
2.  Haga clic en un paquete para seleccionarlo. Esto cambia el nombre que aparece al lado del ícono en el que hizo clic para abrir el árbol ([Figura 337](#packageselection)).
    
3.  Haga clic en el botón de confirmación ([![image9](_images/image392.png)](_images/image392.png)). Esto cierra el árbol de paquetes.
    

[![Primer paso para selección de paquete](_images/image402.png)](_images/image402.png)

Figura 337 Primer paso para selección de paquete[](#id54 "Link to this image")

[![Árbol de paquetes abierto, listo para que se seleccione uno.](_images/image412.png)](_images/image412.png)

Figura 338 Árbol de paquetes abierto, listo para que se seleccione uno.[](#id55 "Link to this image")

[![Selección del paquete Pruebas.](_images/image422.png)](_images/image422.png)

Figura 339 Selección del paquete Pruebas.[](#id56 "Link to this image")

Para seleccionar el tipo de vista, utilice el cuadro que aparece en la parte derecha de la pantalla ([Figura 340](#viewselector)). Hay dos categorías de tipos de vista: vistas de ítems públicos y vistas de ítems personales. Inicialmente se muestran solamente los tipos de vistas con ítems públicos. El ícono de la estrella permite cambiar la pantalla para que muestre los ítems de vistas de ítems personales y viceversa.

[![Cuadro para seleccionar el tipo de vista. A la derecha, arriba, el ícono de la estrella para alternar entre vistas con ítems públicos y vistas con ítems personales.](_images/image432.png)](_images/image432.png)

Figura 340 Cuadro para seleccionar el tipo de vista. A la derecha, arriba, el ícono de la estrella para alternar entre vistas con ítems públicos y vistas con ítems personales.[](#id57 "Link to this image")
...
#### Definición de una vista[](#definicion-de-una-vista "Link to this heading")
...
[![Definición de una vista: Detalles](_images/image442.png)](_images/image442.png)

Figura 341 Definición de una vista: Detalles[](#id58 "Link to this image")
...
[![Definición de una vista: Columnas](_images/image452.png)](_images/image452.png)

Figura 342 Definición de una vista: Columnas[](#id59 "Link to this image")

Para **borrar** una columna o **modificar** sus propiedades, selecciónela. Cuando se selecciona una columna, Qflow muestra sus propiedades y habilita el botón que permite borrarla (ver [Figura 343](#columnselector)).

[![Sección de configuración de columnas](_images/image462.png)](_images/image462.png)

Figura 343 Sección de configuración de columnas[](#id60 "Link to this image")
...
[![Agregar una columna](_images/image482.png)](_images/image482.png)

Figura 344 Agregar una columna[](#id61 "Link to this image")
...
La [Figura 345](#viewwithlink) muestra un ejemplo de vista con el formato “Mostrar como vínculo”.

[![Ejemplo de vista con formato de vínculo en su última columna](_images/image491.png)](_images/image491.png)

Figura 345 Ejemplo de vista con formato de vínculo en su última columna[](#id62 "Link to this image")

Es posible agregar nuevas funciones de formato de columna en el archivo _ScriptsViewsColumnFormatters.js_ dentro del directorio de Qflow Task, el cual tiene formato de diccionario. Este proceso es sencillo siguiendo como ejemplo las funciones que ya existen.
...
[![Ordenar](_images/image502.png)](_images/image502.png)

Figura 346 Ordenar[](#id63 "Link to this image")
...
###### Filtros complejos[](#filtros-complejos "Link to this heading")
...
Otra forma de entender los grupos es considerar la [Figura 347](#filtersandconditions). En la figura, una condición es un nodo rectangular del árbol. Un grupo es una rama del árbol. En este caso, hay un solo grupo cuya raíz se representa mediante un círculo.

[![Combinación de filtros con grupos de condiciones](_images/image513.png)](_images/image513.png)

Figura 347 Combinación de filtros con grupos de condiciones[](#id64 "Link to this image")
...
1.  Haga clic en el ícono “+Grupo” para agregar un grupo. Esto crea un grupo, con una condición vacía, como se muestra en la [Figura 348](#newgroup).
    
2.  Haga clic en el ícono “[![image13](_images/image472.png)](_images/image472.png)”. Qflow muestra las columnas disponibles para agregar a los filtros ([Figura 349](#newcolumn)).
    
3.  Arrastre la columna “Nombre de la plantilla” hacia el grupo que se creó ([Figura 350](#twoconditions)).
...
7.  Haga clic en el botón “Alguna” del grupo. Por ahora, el resultado debería ser como el que se ve en la [Figura 351](#twoconditionsinagroup). Falta agregar la condición de la fecha de inicio.
    
8.  Agregue la columna “Fecha de inicio del proceso”. Esto agrega dentro del grupo una condición que usa la columna “Fecha de inicio del proceso”. Pero lo que se desea es que esa condición esté fuera del grupo ([Figura 352](#threeconditionsinagroup)).
    
9.  Arrastre la condición hacia afuera del grupo, manteniendo el botón del ratón apretado mientras el cursor está sobre el ícono “+” que aparece en la condición. Mueva el ratón hacia arriba, hasta que la condición esté sobre los botones “Todas” y “Alguna” que están fuera del grupo. Suelte el botón del ratón. El resultado debería ser el de la [Figura 353](#moveconditions). Si la condición queda dentro del grupo, vuelva a intentarlo, recordando que debe soltar el botón del ratón fuera del grupo.
    
10.  Modifique esa condición para que el operador sea “mayor o igual” y la fecha 1/1/2016 y los filtros quedarán prontos.
    

[![Un grupo que se acaba de crear](_images/image522.png)](_images/image522.png)

Figura 348 Un grupo que se acaba de crear[](#id65 "Link to this image")

[![Se acaba de agregar la columna "Nombre de la plantilla"](_images/image532.png)](_images/image532.png)

Figura 349 Se acaba de agregar la columna «Nombre de la plantilla»[](#id66 "Link to this image")

[![Las dos condiciones del grupo usan la columna "Nombre de la plantilla"](_images/image542.png)](_images/image542.png)

Figura 350 Las dos condiciones del grupo usan la columna «Nombre de la plantilla»[](#id67 "Link to this image")

[![Dos condiciones dentro de un grupo](_images/image552.png)](_images/image552.png)

Figura 351 Dos condiciones dentro de un grupo[](#id68 "Link to this image")

[![El grupo ahora tiene tres condiciones, pero una debe ser movida hacia afuera](_images/image562.png)](_images/image562.png)

Figura 352 El grupo ahora tiene tres condiciones, pero una debe ser movida hacia afuera[](#id69 "Link to this image")

[![Resultado de mover la nueva condición hacia afuera](_images/image572.png)](_images/image572.png)

Figura 353 Resultado de mover la nueva condición hacia afuera[](#id70 "Link to this image")
...
2.  Donde dice “Acceso permitido a”, introduzca los miembros a los cuales desee permitir ver la vista ([Figura 354](#restrictpermissions)). Para hacer eso, escriba, donde dice “Comience a escribir un rol”, parte del nombre del miembro de Qflow al que desee otorgar el permiso (el miembro puede ser un rol, grupo, usuario, nodo o cola de trabajo de Qflow; ver [Manejo de Permisos](#manejo-de-permisos)). Qflow mostrará miembros cuyos nombres contengan el texto ingresado. Haga clic en el miembro que desee agregar para seleccionarlo. Esto lo agregará a la lista. Para quitarlo, haga clic en la cruz que aparece en la parte derecha del nombre.
    

[![Restringir los permisos de acceso a una vista al rol “Diseñador”](_images/image582.png)](_images/image582.png)

Figura 354 Restringir los permisos de acceso a una vista al rol “Diseñador”[](#id71 "Link to this image")

[![El rol "Diseñador" en la lista de acceso permitido de una vista](_images/image592.png)](_images/image592.png)

Figura 355 El rol «Diseñador» en la lista de acceso permitido de una vista[](#id72 "Link to this image")

#### Importación y exportación de vistas[](#importacion-y-exportacion-de-vistas "Link to this heading")
...
[![Pantalla de vistas con opciones de exportar e importar vistas](_images/image602.png)](_images/image602.png)

Figura 356 Pantalla de vistas con opciones de exportar e importar vistas[](#id73 "Link to this image")
...
#### Creación de gráficas[](#creacion-de-graficas "Link to this heading")
...
Consulte la sección sobre creación de vistas ([Creación de una vista](#creacion-de-una-vista)) por más detalles.

#### Definición de una gráfica[](#definicion-de-una-grafica "Link to this heading")
...
A continuación, se describen las secciones “Apariencia”, “Medida” y “Dimensiones”. Las otras funcionan de forma análoga a las secciones con sus mismos nombres en la página de definición de una vista. La sección “Columnas” permite definir las columnas que aparecen en la tabla que acompaña la gráfica y en las tablas que aparecen cuando un usuario hace clic en ella. Por más información sobre cada una de ellas, consulte la sección [Definición de una vista](#definicion-de-una-vista).

##### Apariencia[](#apariencia "Link to this heading")

La sección “Apariencia” ([Figura 358](#charttypes)) permite elegir el tipo de la gráfica (por ejemplo, si es una gráfica de torta o de barras. Los tipos disponibles son los siguientes:

*   **Anillos:** una gráfica de anillos ([Figura 365](#ringchart)) es similar a una gráfica de torta, pero con un hueco en el medio (también se le puede llamar “gráfica de rosquilla” o “gráfica de _donut_”). Vea un ejemplo en [Ejemplo: gráficas sin agrupamiento de datos (columnas, barras, anillo, circular)](#ejemplo-graficas-sin-agrupamiento-de-datos-columnas-barras-anillo-circular).
    
*   **Área superpuesta:** una gráfica de área superpuesta ([Figura 372](#overlappingareachart)) representa los valores mediante una línea. El área debajo de la línea se pinta con un color. Si hay más de una serie de datos, una de las series se superpone a la otra (como si una estuviera en un papel y la otra en otro papel que se coloca sobre el primero y a través del cual es posible ver el de abajo). En esto se diferencia de la gráfica de área apilada. Vea un ejemplo en [Ejemplo: gráfica de línea y gráfica de área](#ejemplo-grafica-de-linea-y-grafica-de-area).
    
*   **Área apilada:** similar a la gráfica de área superpuesta, pero si hay más de una serie de datos, en lugar de superponer las áreas de cada una, se apilan ([Figura 371](#stackedareachart)). Una gráfica de área apilada que fue hecha con los mismos datos que una gráfica de área superpuesta es más alta porque un área se pone encima de la otra (se “apila”). Vea un ejemplo en [Ejemplo: gráfica de línea y gráfica de área](#ejemplo-grafica-de-linea-y-grafica-de-area).
    
*   **Barras** **agrupadas:** gráfica de barras horizontales ([Figura 369](#groupedbarschart)). Si hay más de una dimensión, se agrupan los datos. Una gráfica de barras de una dimensión podría tener, por ejemplo, una barra por cada departamento de la empresa, con cada barra representando la cantidad de tareas pendientes en el departamento correspondiente. Una gráfica similar podría categorizar las tareas pendientes de cada departamento en tres estados, por ejemplo: “Pendiente (normal)”, “Pendiente (atrasada)” y “Finalizada”. Esta gráfica tendría tres dimensiones, una por cada estado. A cada departamento le correspondería un grupo de tres barras, cada una de las cuales correspondería a uno de los tres estados. Un grupo de barras muestra las barras una al lado de la otra, pero agrupadas, cerca una de la otra y lejos de las que corresponden a otros grupos. Vea ejemplos en [Ejemplo: gráficas sin agrupamiento de datos (columnas, barras, anillo, circular)](#ejemplo-graficas-sin-agrupamiento-de-datos-columnas-barras-anillo-circular) y [Ejemplo: gráficas con agrupamiento de datos (columnas apiladas y agrupadas; barras apiladas y agrupadas)](#ejemplo-graficas-con-agrupamiento-de-datos-columnas-apiladas-y-agrupadas-barras-apiladas-y-agrupadas).
    
*   **Barras apiladas:** similar a la de barras agrupadas, pero en lugar de mostrar las barras de un mismo grupo una al lado de la otra, las muestra una arriba de la otra, apiladas ([Figura 368](#stackedbarschart)). Vea ejemplos en [Ejemplo: gráficas sin agrupamiento de datos (columnas, barras, anillo, circular)](#ejemplo-graficas-sin-agrupamiento-de-datos-columnas-barras-anillo-circular) y [Ejemplo: gráficas con agrupamiento de datos (columnas apiladas y agrupadas; barras apiladas y agrupadas)](#ejemplo-graficas-con-agrupamiento-de-datos-columnas-apiladas-y-agrupadas-barras-apiladas-y-agrupadas).
    
*   **Burbujas:** gráfica que representa los valores con círculos cuyo tamaño es proporcional a la magnitud de los valores representados (la medida; ver más abajo; [Figura 374](#bubblechart)). Estas gráficas deben tener al menos dos dimensiones, una para las ordenadas (eje vertical, y) y otra para las abscisas (eje horizontal, x). Estas dos dimensiones son las coordenadas que determinan las posiciones de los círculos en el sistema de ejes cartesianos y también se usan para agrupar los datos (por cada par de valores únicos se dibuja un círculo; o sea que, si un par se repite, se dibuja un solo círculo para todos). Dimensiones adicionales cambian la forma de agrupar los datos. En este caso, pueden surgir nuevas burbujas con el mismo centro que otras burbujas, pero con diferente medida. Por ejemplo, puede haber dos registros con el mismo valor para la primera dimensión (X), el mismo para la segunda (Y) y un valor distinto para una tercera dimensión. Si la medida depende de las tres dimensiones, habrá dos burbujas superpuestas, una con mayor diámetro que la otra. La menor de ambas será marcada con un borde de distinto color, por lo que ambas serán visibles. Vea un ejemplo en [Ejemplo: gráfica de burbujas](#ejemplo-grafica-de-burbujas).
    
*   **Circular:** también llamado “gráfico de torta” ([Figura 364](#circularchart)). Vea un ejemplo en [Ejemplo: gráficas sin agrupamiento de datos (columnas, barras, anillo, circular)](#ejemplo-graficas-sin-agrupamiento-de-datos-columnas-barras-anillo-circular).
    
*   **Columnas agrupadas:** lo mismo que las barras agrupadas, pero en sentido vertical ([Figura 367](#groupedcolumnschart)). Vea ejemplos en [Ejemplo: gráficas sin agrupamiento de datos (columnas, barras, anillo, circular)](#ejemplo-graficas-sin-agrupamiento-de-datos-columnas-barras-anillo-circular) y [Ejemplo: gráficas con agrupamiento de datos (columnas apiladas y agrupadas; barras apiladas y agrupadas)](#ejemplo-graficas-con-agrupamiento-de-datos-columnas-apiladas-y-agrupadas-barras-apiladas-y-agrupadas).
    
*   **Columnas apiladas:** lo mismo que las barras apiladas, pero en sentido vertical ([Figura 366](#stackedcolumnschart)). Vea ejemplos en [Ejemplo: gráficas sin agrupamiento de datos (columnas, barras, anillo, circular)](#ejemplo-graficas-sin-agrupamiento-de-datos-columnas-barras-anillo-circular) y [Ejemplo: gráficas con agrupamiento de datos (columnas apiladas y agrupadas; barras apiladas y agrupadas)](#ejemplo-graficas-con-agrupamiento-de-datos-columnas-apiladas-y-agrupadas-barras-apiladas-y-agrupadas).
    
*   **Dispersión (XY):** una gráfica de dispersión muestra puntos en un par de ejes cartesianos ([Figura 373](#dispersionchart)). El eje horizontal corresponde a la primera dimensión. El eje vertical corresponde a la medida. Si se agrega una dimensión más, los puntos se representan con puntos de colores y la gráfica muestra una referencia que indica qué valor de esa dimensión corresponde a cada color. Vea un ejemplo en [Ejemplo: gráfica de dispersión](#ejemplo-grafica-de-dispersion).
    
*   **Línea:** una gráfica que representa los valores con líneas continuas ([Figura 370](#linechart)). Si se definen dos dimensiones en lugar de una, se dibuja una línea por cada valor de la segunda dimensión. Cada línea tiene un color distinto. Por ejemplo, si la primera dimensión es la fecha de inicio de los procesos y la segunda es el usuario iniciador del proceso, se dibuja una línea por cada usuario que inició un proceso. Cada línea representa los valores de la medida en función de la fecha de inicio de los procesos. Vea un ejemplo en [Ejemplo: gráfica de línea y gráfica de área](#ejemplo-grafica-de-linea-y-grafica-de-area).
    

[![Apariencia: tipos de gráfica disponibles. Los íconos que los representan son bastante ilustrativos](_images/image622.png)](_images/image622.png)

Figura 358 Apariencia: tipos de gráfica disponibles. Los íconos que los representan son bastante ilustrativos[](#id75 "Link to this image")
...
1.  Haga clic en el ícono que aparece en el campo “Columna” ([Figura 359](#measure)). Esto hace que aparezca la lista de columnas disponibles.
    
2.  Haga doble clic en la columna deseada. Esto selecciona la columna. Para cambiar la columna, proceda de la misma forma.
    

[![Medida: el usuario está por seleccionar una columna](_images/image632.png)](_images/image632.png)

Figura 359 Medida: el usuario está por seleccionar una columna[](#id76 "Link to this image")

[![Selección de la columna: columnas disponibles](_images/image642.png)](_images/image642.png)

Figura 360 Selección de la columna: columnas disponibles[](#id77 "Link to this image")
...
[![Agregar una dimensión a una gráfica](_images/image652.png)](_images/image652.png)

Figura 361 Agregar una dimensión a una gráfica[](#id78 "Link to this image")

##### Ejemplo: gráficas sin agrupamiento de datos (columnas, barras, anillo, circular)[](#ejemplo-graficas-sin-agrupamiento-de-datos-columnas-barras-anillo-circular "Link to this heading")
...
[![Gráfica de columnas](_images/image662.png)](_images/image662.png)

Figura 362 Gráfica de columnas[](#id79 "Link to this image")

[![Gráfica de barras](_images/image672.png)](_images/image672.png)

Figura 363 Gráfica de barras[](#id80 "Link to this image")

[![Gráfica circular](_images/image682.png)](_images/image682.png)

Figura 364 Gráfica circular[](#id81 "Link to this image")

[![Gráfica de anillo](_images/image692.png)](_images/image692.png)

Figura 365 Gráfica de anillo[](#id82 "Link to this image")

##### Ejemplo: gráficas con agrupamiento de datos (columnas apiladas y agrupadas; barras apiladas y agrupadas)[](#ejemplo-graficas-con-agrupamiento-de-datos-columnas-apiladas-y-agrupadas-barras-apiladas-y-agrupadas "Link to this heading")

Supongamos que se quiere construir una gráfica que muestre, para cada usuario, cuántos procesos inició de cada plantilla, como se muestra en la [Figura 366](#stackedcolumnschart): por cada usuario se muestra una columna y cada columna está dividida en varias secciones que representan la cantidad de procesos iniciados por ese usuario para cada plantilla.
...
[![Gráfica de columnas apiladas](_images/image702.png)](_images/image702.png)

Figura 366 Gráfica de columnas apiladas[](#id83 "Link to this image")

[![Gráfica de columnas agrupadas](_images/image712.png)](_images/image712.png)

Figura 367 Gráfica de columnas agrupadas[](#id84 "Link to this image")

[![Gráfica de barras apiladas](_images/image722.png)](_images/image722.png)

Figura 368 Gráfica de barras apiladas[](#id85 "Link to this image")

[![Gráfica de barras agrupadas](_images/image732.png)](_images/image732.png)

Figura 369 Gráfica de barras agrupadas[](#id86 "Link to this image")

##### Ejemplo: gráfica de línea y gráfica de área[](#ejemplo-grafica-de-linea-y-grafica-de-area "Link to this heading")
...
[![Gráfica de línea](_images/image742.png)](_images/image742.png)

Figura 370 Gráfica de línea[](#id87 "Link to this image")

[![Gráfica de área apilada](_images/image752.png)](_images/image752.png)

Figura 371 Gráfica de área apilada[](#id88 "Link to this image")

[![Gráfica de área superpuesta](_images/image762.png)](_images/image762.png)

Figura 372 Gráfica de área superpuesta[](#id89 "Link to this image")

##### Ejemplo: gráfica de dispersión[](#ejemplo-grafica-de-dispersion "Link to this heading")

Para hacer una gráfica de dispersión, se pueden usar datos muy similares a los del ejemplo de gráfica de línea, pero la primera dimensión debe ser un número. Si se modifica el ejemplo de la gráfica de línea (ver [Ejemplo: gráfica de línea y gráfica de área](#ejemplo-grafica-de-linea-y-grafica-de-area)) para que el dato de aplicación con la fecha sea de tipo número, se puede obtener una gráfica de dispersión en la que cada que para cada par formado por una fecha y una cantidad de solicitudes hay un punto en la gráfica. Al igual que con la gráfica de línea, se usan diferentes colores para diferentes usuarios.

[![Gráfica de dispersión](_images/image772.png)](_images/image772.png)

Figura 373 Gráfica de dispersión[](#id90 "Link to this image")

##### Ejemplo: gráfica de burbujas[](#ejemplo-grafica-de-burbujas "Link to this heading")
...
El resultado se muestra en la [Figura 374](#bubblechart).

[![Gráfica de burbujas](_images/image782.png)](_images/image782.png)

Figura 374 Gráfica de burbujas[](#id91 "Link to this image")

#### Importación y exportación de gráficas[](#importacion-y-exportacion-de-graficas "Link to this heading")

Las gráficas se exportan e importan de forma análoga a las vistas. Ver [Importación y exportación de vistas](#importacion-y-exportacion-de-vistas) por más información.
...
[![Pantalla de indicadores](_images/image791.png)](_images/image791.png)

Figura 375 Pantalla de indicadores[](#id92 "Link to this image")

Al terminar de modificar las propiedades de cada una de esas secciones, debe hacer clic en “Listo”. Qflow validará los datos y si hay errores, le avisará. Si hace clic en el aviso de los errores, Qflow lo lleva a la parte de la pantalla en la que puede corregir el error.

A continuación, se explican las propiedades de cada sección de la pantalla de definición de un indicador.

#### Creación de indicadores[](#creacion-de-indicadores "Link to this heading")
...
#### Definición de un indicador[](#definicion-de-un-indicador "Link to this heading")
...
##### Detalles[](#detalles-1 "Link to this heading")
...
*   Apariencia: indica la figura que se usará para representar el indicador. Las opciones son:
    ...
    *   **Medidor:** imagen de una aguja que marca un valor en una escala graduada, similar a un velocímetro ([Figura 376](#meterandthermometer), a la izquierda). La escala está dividida por rangos de distintos colores. Estos rangos son los que se definen en la solapa “Rangos”. Cada rango se muestra con el color definido para él (ver más abajo).
        
    *   **Semáforo:** se muestra el valor sobre un fondo del color correspondiente al rango al que pertenece ([Figura 377](#semaphore)).
        
    *   **Termómetro:** se muestra el dibujo de un termómetro que marca el valor que se representa ([Figura 376](#meterandthermometer)). El color de la columna que marca el termómetro es el que le corresponde al valor marcado de acuerdo con el rango al que pertenece.
        
*   **Dígitos decimales:** la cantidad de dígitos decimales que se tendrán en cuenta para el resultado del cálculo del medidor.
    

[![Medidor y termómetro](_images/image801.png)](_images/image801.png)

Figura 376 Medidor y termómetro[](#id93 "Link to this image")

[![Semáforo](_images/image812.png)](_images/image812.png)

Figura 377 Semáforo[](#id94 "Link to this image")
...
Para agregar un rango, haga clic en el ícono del símbolo de “[![image15](_images/image472.png)](_images/image472.png)”. Eso hace que Qflow agregue el nuevo rango a la lista de rangos, con un nombre por defecto y muestre una barra que representa visualmente los rangos. Cuando recién se agregó un rango, la barra lo muestra con un color cualquiera y valores límite de 0 y 50 ([Figura 378](#addrange)). Para modificar las propiedades del rango, hágale clic. Qflow entonces muestra, al lado de la lista de rangos, las propiedades del rango ([Figura 379](#rangeproperties)):
...
*   **Color:** color que se asocia al rango. Para modificar el color hay un selector de colores ([Figura 379](#rangeproperties)).
    

[![Agregar un rango](_images/image822.png)](_images/image822.png)

Figura 378 Agregar un rango[](#id95 "Link to this image")

[![Propiedades de un rango](_images/image832.png)](_images/image832.png)

Figura 379 Propiedades de un rango[](#id96 "Link to this image")

##### Fórmulas[](#formulas "Link to this heading")

En la sección “Fórmula” se define cómo calcular el valor que se muestra en el indicador. La fórmula se representa mediante un árbol que tiene un nodo para cada operación y para cada operando ([Figura 380](#formula)). En el ejemplo de la figura, a la suma de todos los valores de “Compras” se le resta la suma de todos los valores de “Ventas”. El árbol se define desde la raíz, en el tope, hacia abajo. Por lo tanto, lo primero que se define es la última operación que se ejecuta (la raíz), que es la que da como resultado el valor del indicador. A continuación, se definen los operandos de esa operación. Estos operandos pueden ser el resultado de otras operaciones, que a su vez también pueden tener operandos, los cuales pueden ser el resultado de operaciones y así sucesivamente.

[![Una fórmula que sustrae, de la suma de los valores del dato “Compras”, la suma de los valores del dato “Ventas”. El último nodo es del tipo “Columna” y sus propiedades se muestran al lado del árbol.](_images/image842.png)](_images/image842.png)

Figura 380 Una fórmula que sustrae, de la suma de los valores del dato “Compras”, la suma de los valores del dato “Ventas”. El último nodo es del tipo “Columna” y sus propiedades se muestran al lado del árbol.[](#id97 "Link to this image")

Los nodos del árbol pueden ser de varios tipos, cada uno de los cuales está asociado a un tipo de operación u operando. En el árbol, el tipo de un nodo se representa mediante un ícono ([Figura 381](#nodetypebutton)).

[![Botones para asignar tipos de nodo, con los íconos que representan cada tipo](_images/image852.png)](_images/image852.png)

Figura 381 Botones para asignar tipos de nodo, con los íconos que representan cada tipo[](#id98 "Link to this image")
...
Cuando se empieza a definir una fórmula, esta tiene solamente un nodo en el que no está especificada ninguna operación y ningún operando. Para asignar una operación a un nodo, selecciónelo y haga clic en el botón correspondiente al tipo de nodo deseado ([Figura 381](#nodetypebutton)). Esto mostrará, al lado del árbol, un recuadro con las propiedades del tipo del nodo (este recuadro también se muestra si se selecciona un nodo que ya tiene asignado un tipo; ver [Figura 380](#formula)).
...
###### Agregación[](#agregacion "Link to this heading")
...
[![Propiedades de un nodo de agregación](_images/image862.png)](_images/image862.png)

Figura 382 Propiedades de un nodo de agregación[](#id99 "Link to this image")

###### Columna[](#columna "Link to this heading")
...
Para seleccionar una columna, haga clic en el ícono correspondiente ([Figura 383](#columnselection)). Qflow muestra dos solapas, una con datos de aplicación y otra con columnas del sistema. Busque el dato o columna que desee utilizar y hágale clic. Después, haga clic en el ícono de confirmación ([Figura 384](#dataselection)).

[![Selección de una columna](_images/image872.png)](_images/image872.png)

Figura 383 Selección de una columna[](#id100 "Link to this image")

[![Selección del dato de aplicación “Compras” como columna.](_images/image882.png)](_images/image882.png)

Figura 384 Selección del dato de aplicación “Compras” como columna.[](#id101 "Link to this image")

###### Constante[](#constante "Link to this heading")

En el caso de una constante, se ingresa el valor deseado.

[![Definición de una constante](_images/image892.png)](_images/image892.png)

Figura 385 Definición de una constante[](#id102 "Link to this image")

###### Conversión[](#conversion "Link to this heading")
...
[![Selección de una función.](_images/image912.png)](_images/image912.png)

Figura 387 Selección de una función.[](#id104 "Link to this image")

##### Filtros[](#filtros-1 "Link to this heading")

Los filtros permiten restringir los datos que intervienen en el cálculo del indicador. Por ejemplo, en una fórmula que suma todos los valores de un dato de aplicación común a procesos de varias plantillas, se podría querer sumar solamente los valores de los datos de una de esas plantillas. Los filtros se definen de la misma forma que los filtros de las vistas (ver [Definición de una vista](#definicion-de-una-vista)).

##### Parámetros[](#parametros-1 "Link to this heading")

Al igual que los filtros, los parámetros permiten restringir los datos que intervienen en el cálculo del indicador, pero ingresando valores para comparar al momento de ver el indicador. Los parámetros se definen de la misma forma que los parámetros de las vistas (ver [Definición de una vista](#definicion-de-una-vista)).

##### Permisos[](#permisos-1 "Link to this heading")

Permiten restringir el acceso al indicador. Se definen de la misma forma que los permisos de las vistas (ver [Definición de una vista](#definicion-de-una-vista)).

#### Importación y exportación de indicadores[](#importacion-y-exportacion-de-indicadores "Link to this heading")

Los indicadores se exportan e importan de forma análoga a las vistas. Ver [Importación y exportación de vistas](#importacion-y-exportacion-de-vistas) por más información.
...
[![Pantalla de tableros de control](_images/image922.png)](_images/image922.png)

Figura 388 Pantalla de tableros de control[](#id105 "Link to this image")

#### Creación de tableros de control[](#creacion-de-tableros-de-control "Link to this heading")
...
#### Definición de un tablero de control[](#definicion-de-un-tablero-de-control "Link to this heading")
...
##### Detalles[](#detalles-2 "Link to this heading")
...
[![Definición de un tablero de control](_images/image932.png)](_images/image932.png)

Figura 389 Definición de un tablero de control[](#id106 "Link to this image")

##### Permisos[](#permisos-2 "Link to this heading")
...
[![Permisos de un tablero de control](_images/image942.png)](_images/image942.png)

Figura 390 Permisos de un tablero de control[](#id107 "Link to this image")

##### Modificación de qué se muestra en un tablero de control[](#modificacion-de-que-se-muestra-en-un-tablero-de-control "Link to this heading")
...
Al ingresar a la página que muestra un tablero de control, si este está vacío se muestra una pantalla similar a de la [Figura 391](#emptydashboard). Para agregar elementos, haga clic en el vínculo que dice “Agregue nuevos elementos haciendo clic aquí”, o haga clic en el ícono del lápiz (“[![image16](_images/image952.png)](_images/image952.png)”) que aparece en la parte superior derecha y que permite modificar el tablero. Entonces, Qflow muestra los elementos disponibles, cada tipo en una solapa (vistas, gráficas e indicadores; [Figura 392](#dashboardelementsselection)).
...
En general, será necesario modificar el tamaño del elemento. Para eso, haga clic en uno de los íconos que aparecen en las dos esquinas inferiores. Mantenga el botón del ratón apretado y muévalo hasta que el elemento alcance el tamaño deseado ([Figura 393](#dashboardview)).

Una vez finalizada la edición, haga clic en el botón de guardar (“[![image17](_images/image962.png)](_images/image962.png)”).

[![Tablero de control vacío](_images/image972.png)](_images/image972.png)

Figura 391 Tablero de control vacío[](#id108 "Link to this image")

[![Selección de elementos para un tablero de control](_images/image982.png)](_images/image982.png)

Figura 392 Selección de elementos para un tablero de control[](#id109 "Link to this image")

[![Vista de procesos en un tablero de control. El usuario está cambiando su tamaño (ver cursor en la esquina inferior derecha). En la esquina superior derecha aparece la cruz que, si se le hace clic, quita la vista del tablero](_images/image992.png)](_images/image992.png)

Figura 393 Vista de procesos en un tablero de control. El usuario está cambiando su tamaño (ver cursor en la esquina inferior derecha). En la esquina superior derecha aparece la cruz que, si se le hace clic, quita la vista del tablero[](#id110 "Link to this image")

#### Importación y exportación de tableros de control[](#importacion-y-exportacion-de-tableros-de-control "Link to this heading")

Los tableros de control se exportan e importan de forma análoga a las vistas. Ver [Importación y exportación de vistas](#importacion-y-exportacion-de-vistas) por más información.

## Administración y configuración[](#administracion-y-configuracion "Link to this heading")
...
[![Opciones de administración y configuración](_images/image1002.png)](_images/image1002.png)

Figura 394 Opciones de administración y configuración[](#id111 "Link to this image")

Bajo el vínculo de “Configuración del usuario” (este vínculo solo es visible si se tiene un _sender_ configurado), las opciones son:

[![Opciones al tener habilitadas las notificaciones de dispositivo](_images/image1012.png)](_images/image1012.png)

Figura 395 Opciones al tener habilitadas las notificaciones de dispositivo[](#id112 "Link to this image")

[![Opciones al tener deshabilitadas las notificaciones de dispositivo](_images/image1021.png)](_images/image1021.png)

Figura 396 Opciones al tener deshabilitadas las notificaciones de dispositivo[](#id113 "Link to this image")
...
### Manejo de Permisos[](#manejo-de-permisos "Link to this heading")
...
#### Roles y tipos de roles[](#roles-y-tipos-de-roles "Link to this heading")
...
Cuando Qflow muestra una lista de permisos ya asignados, muestra el nombre del rol al que se le asignó el permiso, las operaciones incluidas en el permiso y el tipo del rol al que el permiso fue asignado. Este último dato se indica mediante un ícono que representa el tipo de rol. La [Figura 397](#permissionslistexample) muestra la correspondencia entre íconos y tipos de rol.

[![Ejemplo de cómo se ve un rol, un usuario, una cola de trabajo, un nodo y un grupo en una lista de permisos](_images/image1031.png)](_images/image1031.png)

Figura 397 Ejemplo de cómo se ve un rol, un usuario, una cola de trabajo, un nodo y un grupo en una lista de permisos[](#id114 "Link to this image")
...
#### Operaciones incluidas en los permisos[](#operaciones-incluidas-en-los-permisos "Link to this heading")
...
### Personalización del menú lateral[](#personalizacion-del-menu-lateral "Link to this heading")
...
En ella, Qflow muestra el árbol de opciones del menú ([Figura 398](#menuconfigurationtree)), el cual los muestra ordenados y agrupados tal como aparecen en el menú lateral.

[![Árbol de elementos del menú lateral](_images/menu-configuration-tree.png)](_images/menu-configuration-tree.png)

Figura 398 Árbol de elementos del menú lateral[](#id115 "Link to this image")
...
Para las _carpetas_, la configuración permite configurar lo siguientes campos:
...
[![Configuración de carpeta del menú lateral](_images/menu-folder-configuration.png)](_images/menu-folder-configuration.png)

Figura 399 Configuración de carpeta del menú lateral[](#id116 "Link to this image")

Para el caso de vínculos, existen dos tipos: _personalizados_ y _de sistema_:
...
[![Configuración de elementos personalizados del menú lateral](_images/menu-custom-link-configuration.png)](_images/menu-custom-link-configuration.png)

Figura 400 Configuración de elementos personalizados del menú lateral[](#id117 "Link to this image")

Las propiedades específicas de los elementos personalizados son:

*   **Nombre:** nombre que se muestra en el menú para el elemento.
    
*   **URL:** dirección web a la que llevará el elemento al ser seleccionado. Esta puede ser una dirección absoluta, en cuyo caso debe ser una dirección completa (es decir, completa con su protocolo, comenzando con «_https://_» o «_http://_»), o en caso de no serlo se considerará como una dirección relativa al sitio de Qflow Task.
...
[![Configuración de elementos de sistema del menú lateral](_images/menu-system-link-configuration.png)](_images/menu-system-link-configuration.png)

Figura 401 Configuración de elementos de sistema del menú lateral[](#id118 "Link to this image")
...
[![Restringir permisos para vínculos del menú lateral](_images/menu-restrict-access.png)](_images/menu-restrict-access.png)

Figura 402 Restringir permisos para vínculos y carpetas del menú lateral[](#id119 "Link to this image")

Los cambios en la configuración del menú solo se guardan al hacer clic en el botón “Guardar”.

En la parte superior derecha del recuadro donde se muestra el árbol de vínculos hay íconos que permiten realizar operaciones: **borrar el vínculo seleccionado**, **agregar un vínculo** y **agregar una carpeta**. La [Figura 403](#editlinksbutton) muestra los íconos y sus significados. Para ver y modificar las propiedades de un vínculo o carpeta, selecciónelo en el árbol. Para cambiarlo de lugar en el árbol, selecciónelo manteniendo apretado el botón del ratón y arrástrelo hacia el lugar donde desea que esté.

[![Botones para modificar el árbol de vínculos](_images/image1061.png)](_images/image1061.png)

Figura 403 Botones para modificar el árbol de vínculos[](#id120 "Link to this image")
...
#### Importación y exportación de configuración de menú lateral[](#importacion-y-exportacion-de-configuracion-de-menu-lateral "Link to this heading")

Los botones de exportación e importación de configuración (ver [Figura 403](#editlinksbutton)) permiten exportar la configuración de vínculos y carpetas del menú lateral a un archivo que se puede importar en otro ambiente en el que esté instalado Qflow (por ejemplo, para exportarlos de un ambiente de desarrollo a un ambiente de prueba o producción).
...
### Mis vínculos[](#mis-vinculos "Link to this heading")
...
### Vistas del sistema[](#vistas-del-sistema "Link to this heading")
...
Las vistas del sistema se modifican de la misma forma que las vistas personalizadas. Consulte la sección [Definición de una vista](#definicion-de-una-vista) por instrucciones sobre cómo modificarlas. Las vistas del sistema son de los mismos tipos que las vistas comunes, pero existe un tipo adicional, “Bandeja”, que son vistas que se usan en las bandejas de las colas de trabajo.

[![Vistas del sistema](_images/image1071.png)](_images/image1071.png)

Figura 404 Vistas del sistema[](#id121 "Link to this image")

### Bandejas de colas de trabajo[](#bandejas-de-colas-de-trabajo "Link to this heading")
...
[![Administrar bandejas de colas de trabajo](_images/image1081.png)](_images/image1081.png)

Figura 405 Administrar bandejas de colas de trabajo[](#id122 "Link to this image")
...
Al hacer clic en el botón de agregar ([![image19](_images/image472.png)](_images/image472.png)), aparecen las vistas disponibles para agregar a la bandeja. Son las mismas vistas que las que una cola de trabajo tiene por defecto. Arrastre las que desee hasta donde dice “Arrastre aquí”. Al finalizar, haga clic en “Guardar”.

[![Personalizar las vistas de esta bandeja](_images/image1091.png)](_images/image1091.png)

Figura 406 Personalizar las vistas de esta bandeja[](#id123 "Link to this image")

[![Agregar una vista a una bandeja](_images/image1101.png)](_images/image1101.png)

Figura 407 Agregar una vista a una bandeja[](#id124 "Link to this image")

### Permisos de paquete[](#permisos-de-paquete "Link to this heading")
...
[![Permisos de paquete](_images/image1112.png)](_images/image1112.png)

Figura 408 Permisos de paquete[](#id125 "Link to this image")

Por defecto, la página de permisos de paquete muestra los permisos del paquete Raíz. Para seleccionar otro paquete, haga clic en el botón de seleccionar paquete ([![image20](_images/image1122.png)](_images/image1122.png)), que aparece al lado del nombre del paquete seleccionado. Esto hace que Qflow muestre el árbol de paquetes y cambie este ícono por un ícono de confirmación ([![image21](_images/image1132.png)](_images/image1132.png)). Haga doble clic en el paquete deseado, o selecciónelo y haga clic en el ícono de confirmación.

Al agregar un permiso, después de haber seleccionado el miembro al que se desea otorgar o negar permisos, aparece a la derecha de la lista de permisos un recuadro que permite marcar qué permisos se quieren asignar o denegar ([Figura 411](#updatepermissions)). Este recuadro también aparece cuando se están editando los permisos de un miembro para ese paquete.
...
Figura 409 Selección de un paquete[](#id126 "Link to this image")

[![Selección de un miembro para modificar permisos](_images/package-permissions-member-select.png)](_images/package-permissions-member-select.png)

Figura 410 Selección de un miembro para modificar permisos[](#id127 "Link to this image")

[![Modificación de permisos](_images/image1152.png)](_images/image1152.png)

Figura 411 Modificación de permisos[](#id128 "Link to this image")

### Permisos de la herramienta[](#permisos-de-la-herramienta "Link to this heading")
...
[![Administrar permisos de la herramienta](_images/image1162.png)](_images/image1162.png)

Figura 412 Administrar permisos de la herramienta[](#id129 "Link to this image")

Para agregar un permiso:

1.  Haga clic en el ícono “[![image22](_images/image472.png)](_images/image472.png)”. Eso hace que Qflow muestre, en la parte superior izquierda de la pantalla, una caja de texto para ingresar el nombre de un miembro al que se pueden otorgar permisos.
    
2.  Comience a escribir el nombre del miembro para que Qflow muestre la lista de miembros cuyos nombres contengan el texto ingresado y seleccione el miembro deseado. Eso hace que Qflow agregue el miembro a la lista y muestre, a la izquierda, un recuadro en el que se puede marcar qué permisos tendrá el miembro. Por defecto, está marcado el permiso “Acceder a la herramienta” ([Figura 413](#permissionslist)).
    
3.  Modifique los permisos según lo que desee y haga clic en “Guardar”.
    

[![Lista de permisos en la que se acaba de agregar el rol "Diseñador", con recuadro a la derecha para asignar permisos.](_images/image1172.png)](_images/image1172.png)

Figura 413 Lista de permisos en la que se acaba de agregar el rol «Diseñador», con recuadro a la derecha para asignar permisos.[](#id130 "Link to this image")
...
Al ingresar por primera vez al sitio y teniendo el _sender_ configurado correctamente desde Qflow Admin. Se le mostrara un _popup_ en el que se pregunta si desea habilitar las notificaciones de dispositivo, con 3 opciones: Sí, No y Cerrar (‘x’) Ver [Figura 414](#notificationspopup).

[![Popup para habilitar notificaciones de dispositivo al ingresar por primera vez a Qflow Task.](_images/image1182.png)](_images/image1182.png)

Figura 414 Popup para habilitar notificaciones de dispositivo al ingresar por primera vez a Qflow Task.[](#id131 "Link to this image")

Si selecciona “Cerrar”, se interpretará que no desea tomar la decisión en el momento, por lo que el _popup_ se cerrará y se le volverá a mostrar cuando vuelva a ingresar al sitio luego de 7 días o al borrar los datos del navegador.

Si selecciona la opción “No”, se guardará su preferencia y no se le volverá a mostrar el _popup_.

Si selecciona la opción “Sí”:

*   Si nunca se configuraron las notificaciones en el navegador que se está utilizando (Ej: Chrome) se mostrará el _popup_ nativo del navegador, donde se podrá permitir las notificaciones, bloquearlas o cerrar. Ver [Figura 415](#configurechromenotifications)
...
[![Configurar notificaciones en navegador Google Chrome.](_images/image1192.png)](_images/image1192.png)

Figura 415 Configurar notificaciones en navegador Google Chrome.[](#id132 "Link to this image")

Si el usuario ya tiene configuradas (bloqueadas o habilitadas) las notificaciones en el navegador:

*   En el caso de que estén habilitadas, las notificaciones se habilitarán automáticamente al seleccionar la opción Sí en el _popup_ del sitio.
    
*   En el caso de que estén bloqueadas y seleccione la opción “Sí”, se mostrará una alerta ([Figura 416](#blockednotifications)) indicando que tiene las notificaciones del navegador bloqueadas y que debe habilitarlas, este procedimiento deberá realizarlo de forma manual en su navegador. En este caso se le volverá a preguntar si desea activarlas pasados 7 días.
    

[![Aviso de notificaciones de dispositivo bloqueadas en navegador.](_images/image1202.png)](_images/image1202.png)

Figura 416 Aviso de notificaciones de dispositivo bloqueadas en navegador.[](#id133 "Link to this image")
...
Si tiene las notificaciones de dispositivo habilitadas, al ingresar desde un nuevo dispositivo, se le dará la opción de permitir, o no, la recepción de notificaciones en ese dispositivo en particular ([Figura 417](#enablenotificationsmessage)). Teniendo en cuenta, al igual que antes, la configuración del navegador que se esté utilizando. Si no las tiene habilitadas no se mostrará ningún mensaje.

[![Mensaje para activar notificaciones en dispositivo actual.](_images/image1212.png)](_images/image1212.png)

Figura 417 Mensaje para activar notificaciones en dispositivo actual.[](#id134 "Link to this image")

### Manejo de zonas horarias[](#manejo-de-zonas-horarias "Link to this heading")
...
[![Opción para cambiar la zona horaria del usuario.](_images/image1222.png)](_images/image1222.png)

Figura 418 Opción para cambiar la zona horaria del usuario.[](#id135 "Link to this image")

[![Panel para seleccionar la zona horaria del usuario.](_images/image1232.png)](_images/image1232.png)

Figura 419 Panel para seleccionar la zona horaria del usuario.[](#id136 "Link to this image")
...
[![Selector de fecha y hora.](_images/image1242.png)](_images/image1242.png)

Figura 420 Selector de fecha y hora.[](#id137 "Link to this image")
