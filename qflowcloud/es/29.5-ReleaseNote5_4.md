...
Para contemplar esta nueva funcionalidad se hizo un ajuste al cálculo de los Q-points, cuyo detalle puedes consultar en [nuestra documentación](21-Q-pointsConsumption.html). Para obtener más información sobre la respuesta de tarea por usuarios externos, accede a la sección de [configuración de tarea de usuario](15-QflowDesign.html#tarea-de-usuario).
...
*   Se añade una opción para ocultar el mensaje que indica que se responderán las tareas en segundo plano al responder una tarea utilizando la función de [«Respuesta rápida»](04-QflowTask.html#respuesta-rapida).
...
[Anterior](29.6-ReleaseNote5_5.html "v5.5") [Siguiente](29.4-ReleaseNote5_3.html "v5.3")
