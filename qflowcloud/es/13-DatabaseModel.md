  Modelo de base de datos — Qflow Cloud        
...
# Modelo de base de datos[](#modelo-de-base-de-datos "Link to this heading")
...
La práctica usual es publicar los reportes como páginas web y agregar vínculos a ellos en Qflow Task. Para obtener información acerca de cómo agregar un vínculo a Qflow Task y cómo controlar el acceso a esos vínculos, consulte el [manual de Qflow Task](04-QflowTask.html).
...
## Esquema de datos[](#esquema-de-datos "Link to this heading")

Esta sección describe las tablas de Qflow y los campos que las componen.

### Tablas: Procesos[](#tablas-procesos "Link to this heading")
...
*   **StorageType:** Indica en que tipo de almacenamiento está guardado el adjunto. Los posibles valores son: _0 = Base de datos de Qflow, 1 = Azure Blob Storage, 2 = Base de datos externa_.
...
*   **EditAction:** String que contiene la acción en la cual se realizó el comentario. Los valores pueden ser: _0 = StartFlow, 1 = EditFlow, 3 = RespondTask, 8 = BotJob, 9 = Unknown_.
...
*   **Status:** Columna calculada que representa el estado actual de la etapa. Los valores posibles son: _0 = Con holgura, 1 = En tiempo, 2 = Retrasada_.
...
### Tablas: Definición de procesos[](#tablas-definicion-de-procesos "Link to this heading")
...
*   **CustomFormTypes:** String con la lista de tipos de formularios a los que aplica el formulario personalizado. Estos valores pueden ser: _StartEvent, UserTask, UserNotificationTask, FlowEdit, FlowForm_.
...
*   **AdresseeType:** Tipo de destinatario. Puede ser _rol_ (0), _dato_ (1), _parametro_ (2) o _email_ (3).
...
### Tablas: Organigrama[](#tablas-organigrama "Link to this heading")
...
*   **NotificationServiceType:** Tipo de servidor de la subscripción. Los valores posibles son: _0 = Fcm_.
...
### Tablas: Configuración[](#tablas-configuracion "Link to this heading")
...
*   **TenantType:** Tipo de espacio de trabajo. Estos valores pueden ser: _0 = Local, 1 = ExternalDB._
...
*   **Language:** Representa el lenguaje del espacio de trabajo. Los valores posibles son: _0 = Inglés, 1 = Español, 2 = Portugués_.
...
*   **ParameterValue:** Valor del parámetro. Este puede ser _null_ o un string con el valor configurado.
    
*   **DataType:** Tipo de dato del parámetro. Estos valores pueden ser: _0 = String, 1 = Int, 2 = Boolean, 3 = FileUploader, 4 = Combobox._
...
*   **DataType:** Tipo de dato de la propiedad extendida. (_0 = String, 1 = Int, 2 = DateTime, 3 = Boolean, 4 = SecurityMember, 5 = ItemList)_.
...
*   **Protocol:** Indica el protocolo que se utiliza para comunicarse con el servicio (_0 = TCP, 1 = HTTPS, 2 = HTTP, 3 = MessageQueue_).
...
*   **SupportedMailFormats:** String que contiene la lista de tipos de mail soportados por el servicio. Este puede contener ninguno, uno o más de los siguientes tipos: _Xml, Text, HtmlLink, HtmlFrame._
    
*   **Type:** Tipo de servicio de notificación. Los valores pueden ser: _0 = SMTP, 1 = ExtendedMAPI, 2 = ExchangeWS, 3 = FcmPushNotifications_
...
### Tablas: Licencias[](#tablas-licencias "Link to this heading")
...
## Diagramas de Entidad Relación[](#diagramas-de-entidad-relacion "Link to this heading")
...
### MER: Definicion de procesos[](#mer-definicion-de-procesos "Link to this heading")
...
### MER: Procesos[](#mer-procesos "Link to this heading")
...
### MER: Organigrama[](#mer-organigrama "Link to this heading")
